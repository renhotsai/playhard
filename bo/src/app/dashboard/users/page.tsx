...
// Type for Better Auth organization member response
...
export default function UsersPage() {
	...
	const { data: orgData, isLoading: isLoadingMembers } = useQuery({
		...
		queryFn: async () => {
			...
			// Use Better Auth API for organization members
			...
			<Card>
				...
				<CardContent>
					{activeOrganization?.id ? (
						<div>
							{isLoadingMembers ? (
								<LoadingCard message="Loading members..." />
								...
								<div className="rounded-md border">
									<Table>
										...
										<TableBody>
											{orgData?.members?.map((member: BetterAuthMember) => (
